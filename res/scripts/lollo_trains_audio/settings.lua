...
return {
    ...
    soundSetsThatReceiveTheCloseDoorsSound = {
        ...
        {soundSetName = '/br_1440_waggon_enno.lua', wavName = 'closeDoors/bitte-zurueckbleiben-01.wav'},
    ...
    soundSetsThatReceiveTheOpenDoorsSound = {
        {soundSetName = '/1044_sound.lua', wavName = 'openDoors/mind-the-gap-03.wav'},
        ...
        -- {soundSetName = '/train_trieb_br423', wavName = 'openDoors/mind-the-gap-03.wav'}, -- br 422, 423, 430 -- too much
